<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\Program Files\xampp\htdocs/application/game\view\douniuplaywjy\index.html";i:1513153464;s:74:"D:\Program Files\xampp\htdocs/application/game\view\douniuplaywjy\mp3.html";i:1502376220;s:74:"D:\Program Files\xampp\htdocs/application/game\view\douniuplaywjy\img.html";i:1500606572;}*/ ?>
<!DOCTYPE>
<html>
<head>
...
<div class="container">
    <div class="header">
        ...
        <p class="msg-action"><img src="__STATIC__/game/img/guize.png" class="rule"><img
                src="__STATIC__/game/img/guanzhu.png"><img class="inviteico" src="__STATIC__/game/img/invite.png"></p>
    </div>
    <div class="desk">
        <div class="players1">
...
<script src="__STATIC__/js/pokershow.js?v=1.7"></script>
    ...
    $(document).ready(function () {
        ...
        socket.on('new_msg', function (msg) {
            ...
            if (ret.type == 999) {
                ...
                $.jinbiflyall('<img style="border-radius: 20px;" width="15" src=\'__STATIC__/game/img/jinbi.png\'>','.member__',ret.data,function(){
                    $('.cardsbox').hide();
